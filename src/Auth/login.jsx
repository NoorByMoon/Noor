          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="mt-1 block w-full px-3 py-2 text-black bg-white border border-gray-300 rounded-md text-sm shadow-sm pr-10 placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500"
              />
              <div className="absolute inset-y-5 right-2 flex items-center cursor-pointer">
                {visible ? (
                  <BsFillEyeSlashFill
